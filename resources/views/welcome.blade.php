        ...
        <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
            @auth
                <a href="{{ route('contact.create') }}"
                   class="text-sm text-gray-700 dark:text-gray-500 underline">Contact</a>
                <a href="{{ url('/admin') }}"
                   class="text-sm text-gray-700 dark:text-gray-500 underline">Backend</a>
            @else
                <a href="{{ route('contact.create') }}"
                   class="text-sm text-gray-700 dark:text-gray-500 underline">Contact</a>
                ...
                <div class="p-6">
                    ...
                    <div class="ml-12">
                        <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                            <strong> Laravel has wonderful, thorough documentation covering every aspect of the
                                framework. Whether you are new to the framework or have previous experience with
                                Laravel, we recommend reading all of the documentation from beginning to end.</strong>
                        </div>
                    </div>
                </div>
